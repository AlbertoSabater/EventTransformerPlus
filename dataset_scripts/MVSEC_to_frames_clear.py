...
sys.path.append('..'); import transformations
...
for sequence in [
    ...
    chunks_per_depth, k, minTime, maxTime = 1,  2, -1, 256*1000
    ...
    path_dataset_dst =  '/mnt/hdd/datasets_hdd/MVSEC_final/'
